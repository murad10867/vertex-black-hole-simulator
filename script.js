(() => {
  ...
  document.addEventListener('keydown', (event) => {
    ...
    if (code === 'ArrowLeft') holeX -= HOLE_KEY_STEP;
    if (code === 'ArrowRight') holeX += HOLE_KEY_STEP;
    if (code === 'ArrowUp') holeY -= HOLE_KEY_STEP;
    if (code === 'ArrowDown') holeY += HOLE_KEY_STEP;
